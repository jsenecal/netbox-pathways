...
const MODULES = new Set(['sidebar.ts', 'popover.ts', 'external-layers.ts', 'draw-controls.ts', 'map-utils.ts', 'map-core.ts', 'data-layers.ts', 'coord-parser.ts', 'widget-shell.ts']);
